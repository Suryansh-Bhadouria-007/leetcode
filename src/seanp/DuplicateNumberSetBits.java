...
public class DuplicateNumberSetBits {
    public static void main(String[] args) {
        DuplicateNumberSetBits duplicateNumberSetBits = new DuplicateNumberSetBits();
        int a[] = {1, 3, 2, 3, 4};
        System.out.println(duplicateNumberSetBits.findDuplicate(a));
    }
